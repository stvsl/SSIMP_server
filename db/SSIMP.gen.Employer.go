...
func (obj *_EmployerMgr) Debug() *_EmployerMgr {
...
func (obj *_EmployerMgr) Get() (result Employer, err error) {
	err = obj.DB.WithContext(obj.ctx).Model(Employer{}).First(&result).Error
...
func (obj *_EmployerMgr) WithIDcard(idcard string) Option {
...
func (obj *_EmployerMgr) GetByOption(opts ...Option) (result Employer, err error) {
	...
	err = obj.DB.WithContext(obj.ctx).Model(Employer{}).Where(options.query).First(&result).Error
...
func (obj *_EmployerMgr)  GetFromEmployid(employid string) (result Employer, err error) {
	err = obj.DB.WithContext(obj.ctx).Model(Employer{}).Where("`employid` = ?", employid).First(&result).Error
...
func (obj *_EmployerMgr) GetFromIDcard(idcard string) (results []*Employer, err error) {
...
func (obj *_EmployerMgr) GetBatchFromIDcard(idcards []string) (results []*Employer, err error) {
...
func (obj *_EmployerMgr) GetFromTelephone(telephone string) (results []*Employer, err error) {
...
func (obj *_EmployerMgr) GetBatchFromTelephone(telephones []string) (results []*Employer, err error) {
...
func (obj *_EmployerMgr) GetFromBustPhoto(bustPhoto string) (results []*Employer, err error) {
...
func (obj *_EmployerMgr) GetBatchFromBustPhoto(bustPhotos []string) (results []*Employer, err error) {
...
func (obj *_EmployerMgr) GetFromAvatar(avatar string) (results []*Employer, err error) {
...
func (obj *_EmployerMgr) GetBatchFromAvatar(avatars []string) (results []*Employer, err error) {
