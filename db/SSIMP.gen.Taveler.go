...
func (obj *_TavelerMgr) Debug() *_TavelerMgr {
...
func (obj *_TavelerMgr) Get() (result Taveler, err error) {
	err = obj.DB.WithContext(obj.ctx).Model(Taveler{}).First(&result).Error
...
func (obj *_TavelerMgr) GetByOption(opts ...Option) (result Taveler, err error) {
	...
	err = obj.DB.WithContext(obj.ctx).Model(Taveler{}).Where(options.query).First(&result).Error
