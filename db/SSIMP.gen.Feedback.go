...
func (obj *_FeedbackMgr) Debug() *_FeedbackMgr {
...
func (obj *_FeedbackMgr) Get() (result Feedback, err error) {
	err = obj.DB.WithContext(obj.ctx).Model(Feedback{}).First(&result).Error
...
func (obj *_FeedbackMgr) WithPicture(picture string) Option {
...
func (obj *_FeedbackMgr) GetByOption(opts ...Option) (result Feedback, err error) {
	...
	err = obj.DB.WithContext(obj.ctx).Model(Feedback{}).Where(options.query).First(&result).Error
...
func (obj *_FeedbackMgr)  GetFromQid(qid int) (result Feedback, err error) {
	err = obj.DB.WithContext(obj.ctx).Model(Feedback{}).Where("`qid` = ?", qid).First(&result).Error
...
func (obj *_FeedbackMgr) GetFromPicture(picture string) (results []*Feedback, err error) {
...
func (obj *_FeedbackMgr) GetBatchFromPicture(pictures []string) (results []*Feedback, err error) {
