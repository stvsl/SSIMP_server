...
// Admin 管理员信息表		
type	Admin	struct {		
AdminID	string	`gorm:"primaryKey;column:adminID" json:"-"`	// 管理员ID			
EstablishDay	datatypes.Date	`gorm:"column:establish_day" json:"establishDay"`	// 建立日期			
Passwd	string	`gorm:"column:passwd" json:"passwd"`	// 管理员密码			
Name	string	`gorm:"column:name" json:"name"`	// 管理员姓名			
Birthday	datatypes.Date	`gorm:"column:birthday" json:"birthday"`	// 出生年月			
IDcard	int	`gorm:"column:idcard" json:"idcard"`	// 身份证号			
Telephone	int	`gorm:"column:telephone" json:"telephone"`	// 联系电话			
Address	string	`gorm:"column:address" json:"address"`	// 家庭住址			
BustPhoto	[]byte	`gorm:"column:bust_photo" json:"bustPhoto"`	// 半身照片			
Avatar	[]byte	`gorm:"column:avatar" json:"avatar"`	// 头像			
}		
...
// Article 网站文章相关数据		
type	Article	struct {		
Aid	int	`gorm:"primaryKey;column:aid" json:"-"`	// 文章编号			
Title	string	`gorm:"column:title" json:"title"`	// 标题			
Text	string	`gorm:"column:text" json:"text"`	// 正文			
Writetime	time.Time	`gorm:"column:writetime" json:"writetime"`	// 发表日期			
Updatetime	time.Time	`gorm:"column:updatetime" json:"updatetime"`	// 更新日期			
Author	string	`gorm:"column:author" json:"author"`	// 作者			
Pageviews	uint64	`gorm:"column:pageviews" json:"pageviews"`	// 浏览量			
Status	int	`gorm:"column:status" json:"status"`	// 文章状态			
}		
...
Employid	string	`gorm:"primaryKey;column:employid" json:"-"`	// 员工编号			
Employer	Employer	`gorm:"joinForeignKey:employid;foreignKey:employid" json:"employerList"`	// 员工信息表			
StartTime	time.Time	`gorm:"column:startTime" json:"startTime"`	// 开始时间			
EndTime	time.Time	`gorm:"column:endTime" json:"endTime"`	// 结束时间			
TaskCompletion	string	`gorm:"column:task_completion" json:"taskCompletion"`	// 任务完成情况			
InspectionTrack	string	`gorm:"column:inspection_track" json:"inspectionTrack"`	// 巡查轨迹			
}		
...
Employid	string	`gorm:"primaryKey;column:employid" json:"-"`	// 员工编号			
Passwd	string	`gorm:"column:passwd" json:"passwd"`	// 登录密码			
Name	string	`gorm:"column:name" json:"name"`	// 姓名			
BirthDay	datatypes.Date	`gorm:"column:birth_day" json:"birthDay"`	// 出生日期			
EmployDay	datatypes.Date	`gorm:"column:employ_day" json:"employDay"`	// 入职日期			
IDcard	int	`gorm:"column:idcard" json:"idcard"`	// 身份证号			
Address	string	`gorm:"column:address" json:"address"`	// 家庭地址			
Telephone	int	`gorm:"column:telephone" json:"telephone"`	// 联系电话			
BustPhoto	[]byte	`gorm:"column:bust_photo" json:"bustPhoto"`	// 半身照			
Avatar	[]byte	`gorm:"column:avatar" json:"avatar"`	// 头像			
}		
...
Qid	int	`gorm:"primaryKey;column:qid" json:"-"`	// 问题编号			
Question	string	`gorm:"column:question" json:"question"`	// 问题描述			
Description	string	`gorm:"column:description" json:"description"`	// 问题详细描述			
Picture	[]byte	`gorm:"column:picture" json:"picture"`	// 问题图片			
CreateDate	time.Time	`gorm:"column:create_date" json:"createDate"`	// 创建日期			
Sponsor	string	`gorm:"column:sponsor" json:"sponsor"`	// 发起人			
Teleinfo	string	`gorm:"column:teleinfo" json:"teleinfo"`	// 发起人联系方式			
Principal	string	`gorm:"column:principal" json:"principal"`	// 委派负责人			
Status	int	`gorm:"column:status" json:"status"`	// 处理进度			
}		
...
// Syslog 系统日志		
type	Syslog	struct {		
Info	string	`gorm:"column:info" json:"info"`	// 日志信息			
Time	time.Time	`gorm:"column:time" json:"time"`	// 时间			
Text	string	`gorm:"column:text" json:"text"`	// 日志内容			
Extra	string	`gorm:"column:extra" json:"extra"`	// 附加信息			
}		
...
Employid	string	`gorm:"primaryKey;column:employid" json:"-"`	// 员工编号			
Employer	Employer	`gorm:"joinForeignKey:employid;foreignKey:employid" json:"employerList"`	// 员工信息表			
Task	string	`gorm:"column:task" json:"task"`	// 任务			
}		
...
// Taveler 旅客表		
type	Taveler	struct {		
Wxinfo	string	`gorm:"column:wxinfo" json:"wxinfo"`	// 微信登录信息			
ID	string	`gorm:"column:id" json:"id"`	// 旅客id			
Passwd	string	`gorm:"column:passwd" json:"passwd"`	// 登录密码			
History	string	`gorm:"column:history" json:"history"`	// 旅游记录			
}		
